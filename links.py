import os
from one import WebPage
from two import WebElement, ManyWebElements
...
# -------------------------------------- локаторы тестов корзины ------------------------------------------------
    ...
    # локатор книги
    LOCATOR_BOOK_1 = WebElement(xpath='//img[@src="https://img4.labirint.ru/rc/6d6c66d9efe7891957aa3b979e308c60/'
